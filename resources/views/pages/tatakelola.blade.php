...
<head>
    <meta charset="UTF-8">
    <title>Tata Kelola Perusahaan - Bank Jateng Syariah</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary px-3 shadow sticky-top">
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <p>Struktur organisasi & kebijakan internal Bank Jateng</p>
        </div>
    </section>
    ...
    <section class="section-content">
        <div class="container">
            ...
            <p>
                Dalam rangka mewujudkan tata kelola perusahaan yang baik (Good Corporate Governance), Bank Jateng membangun struktur organisasi yang transparan, akuntabel, dan efisien. Struktur ini mendukung pelaksanaan fungsi pengawasan dan pengambilan keputusan yang efektif.
            </p>

            {{-- Jika kamu punya gambar struktur, upload ke folder public/images dan ganti link-nya --}}
            <img src="{{ asset('images/struktur-organisasi.png') }}" alt="Struktur Organisasi" class="structure-img">

            <h2 class="section-title mt-5">Kebijakan Internal</h2>
            <div class="divider"></div>
            <ul>
                <li>Penerapan prinsip transparansi dalam pelaporan keuangan dan kegiatan operasional.</li>
                <li>Peningkatan kompetensi manajemen dan SDM melalui pelatihan berkelanjutan.</li>
                <li>Sistem pengawasan internal yang ketat untuk menghindari konflik kepentingan.</li>
                <li>Etika kerja yang diterapkan dalam seluruh lini perusahaan.</li>
                <li>Audit internal dan eksternal secara berkala untuk menjaga akuntabilitas.</li>
            </ul>
        </div>
    </section>
